...
/**
 * Caso de uso para que un barista marque una orden como LISTO_PARA_ENTREGA.
 */
public class SetOrderReadyUseCase {
    ...
    /**
     * Ejecuta la acción de marcar una orden como lista.
     *
     * @param orderId ID de la orden a marcar como lista.
